...
<template>
    <main class="app-wrapper">
        ...
        <div class="app-content">
            ...
            <div class="container-fluid">
                <p>
                    AdminLTE is an open source project that is licensed under
                    the
                    <a href="https://opensource.org/licenses/MIT">MIT license</a
                    >. This allows you to do pretty much anything you want as
                    long as you include the copyright in “all copies or
                    substantial portions of the Software.” Attribution is not
                ...
                <ul>
                    ...
                    <li>
                        Sublicense: incorporate the work into something that has
