<div class="page-wrapper page-center">
    ...
    <div class="container container-tight py-4">
        <div class="text-center mb-4">
            <a href="#" class="navbar-brand navbar-brand-autodark" aria-label="Never-Ending Nonsense">

                <img src="{{ asset('..\resources\asset\images\logo.svg') }}" width="110" height="32" class="navbar-brand-image"
                    alt="NEN Logo">

                <span class="fw-bold fs-1">Never-Ending Nonsense</span>
            </a>
        </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('login') }}" method="post" autocomplete="off" novalidate="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="user_email" name="email" placeholder="your@email.com" autocomplete="off">
                    </div>
                    <div class="mb-2">
